   ...
   try
    case SaveDialog1.FilterIndex of
     ...
     2,3:
      begin
       ALastExecute(Self);
       SaveMetafileToPDF(report.Metafile,SaveDialog1.FileName,SaveDialog1.FilterIndex=2,qtdriver.InfoProvider);
 //      report.EndPrint;
...
begin
 ...
 SaveMetafileToPDF(report.Metafile,afilename,true,qtdriver.InfoProvider);
